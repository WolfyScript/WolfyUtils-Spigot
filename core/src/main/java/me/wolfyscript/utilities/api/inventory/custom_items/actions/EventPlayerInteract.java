...
public class EventPlayerInteract extends EventPlayer<me.wolfyscript.utilities.api.inventory.custom_items.actions.DataPlayerEvent<PlayerInteractEvent>> {
    ...
    protected EventPlayerInteract() {
        super(KEY, (Class<me.wolfyscript.utilities.api.inventory.custom_items.actions.DataPlayerEvent<PlayerInteractEvent>>)(Object) me.wolfyscript.utilities.api.inventory.custom_items.actions.DataPlayerEvent.class);
    }
