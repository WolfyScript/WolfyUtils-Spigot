...
public class ValueProviderDoubleVar extends ValueProviderVariable<Double> implements ValueProviderDouble {
    ...
    public static final NamespacedKey KEY = NamespacedKey.wolfyutilties("double/var");

    @JsonCreator
    public ValueProviderDoubleVar(@JsonProperty("var") String name) {
        super(KEY, Double.class, name);
    }
}
