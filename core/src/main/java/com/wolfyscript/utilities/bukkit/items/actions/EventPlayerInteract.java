...
public class EventPlayerInteract extends EventPlayer<com.wolfyscript.utilities.bukkit.items.actions.DataPlayerEvent<PlayerInteractEvent>> {
    ...
    protected EventPlayerInteract() {
        super(KEY, (Class<com.wolfyscript.utilities.bukkit.items.actions.DataPlayerEvent<PlayerInteractEvent>>)(Object) com.wolfyscript.utilities.bukkit.items.actions.DataPlayerEvent.class);
    }
