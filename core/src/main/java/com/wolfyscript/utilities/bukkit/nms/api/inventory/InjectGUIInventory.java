...
public class InjectGUIInventory {
    ...
    private static final String GENERATOR_PACKAGE = "com.wolfyscript.utilities.bukkit.nms.api.inventory.generated";
    ...
    public static Class<?> inject(ClassPool classPool, Class<?> originalClass) throws NotFoundException, CannotCompileException, IOException {
        ...
        classPool.importPackage("com.wolfyscript.utilities.bukkit.nms.api.inventory.GUIInventory");
