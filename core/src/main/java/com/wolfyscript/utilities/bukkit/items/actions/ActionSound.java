...
public class ActionSound extends Action<com.wolfyscript.utilities.bukkit.items.actions.DataLocation> {
    ...
    protected ActionSound() {
        super(KEY, com.wolfyscript.utilities.bukkit.items.actions.DataLocation.class);
    }
